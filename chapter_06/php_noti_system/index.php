...
<body>
   ...
   <ul class="nav navbar-nav navbar-right">
    <li class="dropdown">
     <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="label label-pill label-danger count"
       style="border-radius:10px;"></span> <span class="glyphicon glyphicon-globe"
       style="font-size:18px; color: blue;"></span></a>
 ...
 <div class="row">
  ...
  <div class="col-md-6 well" style="background-color: black;">
   <div class="row">
    <div class="col-lg-12">
     <center>
      <h2 class="text-primary">Notification System</h2>
     </center>
     <hr>
     <div>
 ...
 $(document).ready(function() {
  ...
  loadTable();
  // end of fetch data from database and display in table
 })
 </script>
</body>
