    ...
    <div class="container-fluid px-4">
     ...
     <div class="card mb-4">
      <div class="card-header">
       ...
       <h4>Subject List <span class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">+
         Add
         Subject</span></h4>
      </div>
      <div class="card-body">
       ...
       <div class="modal-body">
        <form action="../_actions/subject_create.php" method="POST">
         ...
         <div class="mb-3">
          ...
          <input type="number" name="subject_code" class="form-control" id="">
         </div>
