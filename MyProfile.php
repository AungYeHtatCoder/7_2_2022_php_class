...
// fetching the existing admin records
...
if(isset($_POST['Submit'])) {
 ...
 if(strlen($AHeadline)>30) {
  ...
  if ($Execute) {
    $_SESSION["SuccessMessage"]="Admin Profile Updated Successfully";
    Redirect_to("MyProfile.php");
  }else {
...
<body>
 ...
 <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container">
   <a href="#" class="navbar-brand"> selfstudy.com</a>
 ...
 <footer class="bg-dark text-white">
  <div class="container">
   <div class="row">
    <div class="col">
     <p class="lead text-center">Theme By | Dhammavira Group | <span id="year"></span> &copy; ----All right Reserved.
     </p>
